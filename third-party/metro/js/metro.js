...
/*
Metro['hint'] = {
    create: function(options, elm){
        return Hint.init(options, elm);
    }
};
*/
...
var InfoBox = {
    ...
    _createStructure: function(){
        ...
        element.css({
            ...
            height: o.height,
            visibility: "hidden",
            right: (o.right == "auto" ? ( $(window).width()-element.outerWidth())/2 : o.right),
            bottom: (o.bottom == "auto" ? "10%" : o.bottom)
        });
    ...
    _setPosition: function(){
        var element = this.element;
        element.css({
            bottom: (this.options.bottom =="auto" ? ($(window).height()-element.outerHeight())*0.7 : this.options.bottom),
            right: (this.options.right == "auto" ? ($(window).width()-element.outerWidth())/2 : this.options.right),
        });
    },
