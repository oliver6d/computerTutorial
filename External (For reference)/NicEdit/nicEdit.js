...
var nicEditor = bkClass.extend({
	...
	// Selects single text area to be replaced with nicEdit with panel directly above
	panelInstance : function(e,o) {
		//e = this.checkReplace($BK(e));
		var panelElm = new bkElement($BK('home-section'));
		this.setPanel(panelElm);
		return this.addInstance(e,o);	
	},

	// called by page to add a dom element to be a nicEditor
	...
	// called by page to set dom element for panel
	setPanel : function(e) {
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		for(button in this.ne.options.buttons) {
			if(bkLib.inArray(this.buttonList,button)){
				this.addButton(button,this.ne.options);
			}
		}
	...
	addButton : function(buttonName,options) {
		var button = options.buttons[buttonName];
		var type = (button['type']) ? eval('(typeof('+button['type']+') == "undefined") ? null : '+button['type']+';') : nicEditorButton;
		//var hasButton = bkLib.inArray(this.buttonList,buttonName);
		if(type) {
			this.panelButtons.push(new type(buttonName,options,this.ne));
		}
	},
...
var nicLinkOptions = {
	buttons : {
		'link' : {name : 'Add Link', type : 'nicLinkButton', tags : ['A'], group:'insert'},
		'unlink' : {name : 'Remove Link',  command : 'unlink', noActive : true, group:'insert'}
	}
};
...
var nicImageOptions = {
	buttons : {
		'image' : {name : 'Add Image', type : 'nicImageButton', tags : ['IMG'], group:'insert'}
	}
};
...
var nicSaveOptions = {
	buttons : {
		'save' : {name : __('Save this content'), type : 'nicEditorSaveButton', group:'file'}
	}
};
